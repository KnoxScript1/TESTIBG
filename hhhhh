...
t1[7] = function(p31)
    if not pcall(function()
        ...
        warn("KairisHub: Ваш исполнитель не поддерживает Drawing API для линий.")
...
t1[28] = function()
    ...
    createInstance49("TextLabel", v797, {
		...
		Text = "Murder Mystery 2 | KairisHub",
		Position = uDim2_134,
		ZIndex = 6
	})
...
t1[28] = function()
    ...
    t9.showNotification("KairisHub", "Script successfully loaded!", 3.5)
